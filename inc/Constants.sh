...
#   . /usr/local/AppWarden/inc/Constants.sh
#
...
then
  ...
  # Sets the following AppWarden globals:
  #
  #  GLB_sv_ProjectName                     - Project name (AppWarden)
  #  GLB_sv_ProjectInitials                 - Project initials (AW)
  #  GLB_sv_ProjectDeveloper                - Project developer (com.github.execriez)
  #  GLB_sv_ProjectVersion                  - Project version (i.e. 1.0.4)
  #
  #  GLB_iv_MaxLogSizeBytes                 - Maximum length of AppWarden log(s)
  ...
  #
  #  Key:
  #    GLB_ - AppWarden global variable
  #
